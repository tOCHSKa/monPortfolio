<template>
  <div class="mx-auto pt-[60px] pb-[100px]">
    <div class="container">
      <div class="about_inner">
        ...
        <div class="text">
          ...
          <div class="button_border">
            <a href="UbedaKevinCV.pdf" download>Télécharger mon CV</a>
          </div>
        </div>
      </div>
    </div>
...
.in {
  filter: drop-shadow(-3px 7px 0px #fff);
}
...
.inside {
  ...
  background: linear-gradient(90deg, rgb(33, 231, 134) 0%, rgb(34, 54, 219) 100%);
