<template>
  <div class="absolute top-0 left-0 w-full h-full z-20 flex animated-show overflow-hidden">
    ...
    <div
      class="absolute h-[50px] w-[1px] border-[1px]
       border-[#21E786] top-[50%] left-[50%] transform-translate animated-line"
    ></div>
  </div>
</template>
...
.animated-width-left {
  animation: growWidth-left 1s ease;
  animation-delay: 2s;
  animation-fill-mode: forwards;
}
...
.animated-width-right {
  animation: growWidth-right 1s ease;
  animation-delay: 2s;
  animation-fill-mode: forwards;
}
