<template>
  <div class="fixed w-full top-0 z-30">
    <div class="bg-[#040b11] navbar top-0 text-white relative z-10 shadow-lg">
      <div
        class="max-w-[1440px] bg-[#040b11] mr-auto ml-auto
      ...
      >
        ...
        <div class="flex">
          <ul class="flex flex-row text-white items-center justify-center poppins navbar-ul">
            ...
            <li class="py-[42px] pr-[36px]">
              <a href="#" @click.prevent="scrollToSection('project')">PROJECT</a>
            </li>
            <li class="py-[42px] pr-[36px] pl-0">
        ...
        <div class="flex gap-5 poppins">
          <a
            ...
            class="w-[48px] h-[48px] flex items-center justify-center bg-[#141b22] rounded-[50%]"
          >
            <img src="https://binaboxnextjs.vercel.app/assets/images/icon/sun.png" alt="" />
          </a>
          <a
            href="https://discord.gg/kqUzqrW8Md"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="discord logo"
            class="py-[12px] px-[20px] bg-[#141b22] inline-flex
             items-center tf-button transition-all duration-300 ease close discord"
          >
            <box-icon type="logo" name="discord-alt" color="white" class="mr-[10px]"></box-icon>
            <span>DISCORD</span>
          </a>
          <a
            href="https://github.com/tOCHSKa"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="discord logo"
            class="py-[12px] px-[24px] bg-[#21E786] hover:bg-[#141b22] border-[2px]
             border-[#21E786] inline-flex items-center github transition-all duration-300 ease"
          >
            <box-icon type="logo" name="github" color="white" class="mr-[10px]"></box-icon>
            <span>GITHUB</span>
          </a>
          <div
            class="flex items-center justify-center burger
             cursor-pointer transition-all duration-300 ease"
            @click="toggleIsClicked"
            @keydown="toggleIsClicked"
            tabindex="0"
          >
            <Icon
              v-if="!isClicked"
              ...
              style="color: #fff"
            />
            <Icon v-else icon="akar-icons:cross" width="36" height="36" style="color: #fff" />
          </div>
        </div>
      </div>
      <div
        class="navslide absolute bg-[#141b22] w-full transition-all duration-300 ease"
      ...
      >
        ...
        >
          <a
            @click.prevent="scrollToSection(item.url)"
            @keydown="scrollToSection(item.url)"
            class="text-white poppins hover:text-[#21E786]"
            >{{ item.name }}</a
          >
          <Icon
            :icon="item.icon"
...
const menuItems = ref([
  { name: "HOME", icon: "solar:arrow-right-linear", url: "home" },
  { name: "ABOUT", icon: "solar:arrow-right-linear", url: "about" },
  { name: "PROJECT", icon: "solar:arrow-right-linear", url: "project" },
