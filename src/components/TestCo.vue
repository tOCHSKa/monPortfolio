<template>
  <div class="w-[500px] mx-auto">
    <p>
      Je suis un p avec un
      <span :style="{ backgroundSize: `${bgSize}% 100%` }" class="text_gradient">SpanSpanSpan</span>
    </p>
    <p>
      Je suis un p avec un
      <span :style="{ backgroundSize: `${bgSize1}% 100%` }" class="text_gradient">SpanSpan</span>
    </p>
    <p>
      Je suis un p avec un
      <span :style="{ backgroundSize: `${bgSize2}% 100%` }" class="text_gradient">SpanSpanSp</span>
    </p>
  </div>
</template>
